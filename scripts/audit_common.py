...
A('Real balance decisions, not script errors - each was a deliberate edit during the Roar of Industry '
  'rework and needs a play-test, not a patch:')
A('')
for t in ["**MAX_BUREAUCRACY_PERCENTAGE** 0.01 -> 0.001 (c4a60eb3, 2020-12-16, \"more bureaucrats needed\") "
          ...
          "**BUREAUCRACY_PERCENTAGE_INCREMENT** 0.001 -> 0 (669e751c, 2021-10-16, \"disabled admin "
          ...
          "**INFAMY_STATUS_QUO** 0 -> 1 (bf2f82c2, 2020-12-12, \"better cb fabrication\") - part of the CB "
          ...
          "**BADBOY_LIMIT** 25 -> 50 (4182c8e5, 2018-11-26, \"higher badboy (will see)\") - doubled so a "
