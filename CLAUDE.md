...
Japan at the 1821 start is the Shogunate tag **TKG**, with JAP (the imperial court) and the han tags as its substates (`history/diplomacy/Japan.txt`), so bakufu-level content is scripted on TKG, not JAP.
