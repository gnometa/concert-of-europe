...
- `events/GVG Event IDs.txt` — this team's own additions: `2000000+` setup events, `2000100–2000199` economy pulse host election, and the `1000000+` flavour/chain blocks (JAPFlavorGVG, USAFlavorGVG, BYZFlavorGVG, BELRevolutionGVG, RUSDecembristGVG, GREKingdomGVG). It also records id ranges reserved by deleted files — read it before reusing anything in `999971–999999`, `99902–99904`, `99958`, `999959–999969` or `2260601–2260607`.
- Not in either registry but in use: the Roar of Industry economy rework in `events/00_CoE_RoI.txt` (ids ~99984–99999 and 6016xxx), `97xxx` pulse events (`Canals.txt`, fired from `on_actions.txt`), and `999xxxxx` education/RGO events (`+education_RGO*.txt`). Grep `events/` for an id before taking it.
