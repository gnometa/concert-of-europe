...
country = {
	...
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.2, -- 1.0 -- CoE 2026-09: real-world value, see docs/audit/common.md
	...
	BADBOY_LIMIT = 25, -- 50 -- CoE 2026-09: real-world value, see docs/audit/common.md
	MAX_BUREAUCRACY_PERCENTAGE = 0.01, -- 0.001 -- More than max percent bureaucrats of population will give no additional benefits -- CoE 2026-09: real-world value, see docs/audit/common.md
	BUREAUCRACY_PERCENTAGE_INCREMENT = 0.001, -- 0.000 -- For each social administrative reform level, this is added to MAX_BUREAUCRACY_PERCENTAGE -- CoE 2026-09: real-world value, see docs/audit/common.md
...
diplomacy = {
	...
	INFAMY_PRESTIGE = 1, -- 2
	INFAMY_CONCEDE = 1, -- 1
	INFAMY_STATUS_QUO = 0, -- 0 -- CoE 2026-09: real-world value, see docs/audit/common.md
	INFAMY_ANNEX = 1, -- 10
